...
var mapp;
var poly;
export default class Encendidos extends React.Component {
  constructor(props) {
    super(props);
    this.state =  {
      datag: [],
...
$.ajax({
  url: "http://181.57.227.50:9000/encendidos/"+posi[0].value+"/"+posi[1].value,
  dataType: 'json',
  xhrFields: {
...
EstadoPuerta(estado){
  if(estado=="ignitionOff"){return "Vehiculo apagado"}else{return "Vehiculo Encendido"}
}
...
<h2 className="text-center">Reportes De Encendido Y apagado</h2>
...
<select className="form-control" onChange = {this.updateStatet} name="type">
<option value="00">Seleccione</option>
<option value="ignitionOff">Vehiculo Apagado</option>
<option value="ignitionOn">Vehiculo Encendido</option>
</select>
