...
var mapp;
var poly;
export default class Panicos extends React.Component {
  constructor(props) {
    super(props);
    this.state =  {
      datag: [],
...
$.ajax({
  url: "http://181.57.227.50:9000/panico/"+posi[0].value+"",
  dataType: 'json',
  xhrFields: {
...
<h2 className="text-center">Reportes De Panico</h2>
...
<select className="form-control" onChange = {this.updateStatet}>
<option value="00">Seleccione</option>
<option value="panico">Estado de Panico</option>
</select>
